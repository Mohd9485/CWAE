...
cs.add([
    ...
    Integer("nns1",       (16, 128),                default=96),
    Integer("nns2",       (16, 128),                default=96),
    Integer("nns3",       (16, 128),                default=96),
    Integer("nns4",       (16, 128),                default=96),
    Integer("nns5",       (16, 128),                default=96),
    ...
    Integer("batch_size", (16, 256),    log=True,   default=100),
